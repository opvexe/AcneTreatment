...
- (void)createPlaceholderView:(NSString *) title
    ...
    if(title){
        ...
        [lblTitle setTextColor:[UIColor AT_TextColor]];
    ...
    if(reloadAction){
        ...
        [reButton setBackgroundImage:[UIImage imageWithColor:[UIColor AT_BgColor]] forState:UIControlStateNormal];
        [reButton setBackgroundImage:[UIImage imageWithColor:[UIColor AT_BgColor]] forState:UIControlStateDisabled];
        [reButton setBackgroundImage:[UIImage imageWithColor:[UIColor AT_BgColor]] forState:UIControlStateHighlighted];
        [reButton setTitle:@"重新加载" forState:UIControlStateNormal];
        [reButton setTitle:@"      加载中..." forState:UIControlStateDisabled];
        [reButton setTitleColor:[UIColor AT_MainColor] forState:UIControlStateNormal];
        [reButton setTitleColor:[UIColor AT_MainColor] forState:UIControlStateDisabled];
        ...
        reButton.layer.borderColor =[UIColor AT_MainColor].CGColor;
